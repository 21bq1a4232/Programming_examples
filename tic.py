...
def PrintBoard():
    print()
    print('',board[0],"/",MagicSquare[0], "|", board[1],"/",MagicSquare[1], "|", board[2],"/",MagicSquare[2])
    print("-------|-------|------")
    print('',board[3],"/",MagicSquare[3], "|", board[4],"/",MagicSquare[4], "|",board[5],"/",MagicSquare[5])
    print("-------|-------|------") 
    print('',board[6],"/",MagicSquare[6], "|", board[7],"/",MagicSquare[7], "|",board[8],"/",MagicSquare[8])
    print()
def GetNumber():
    while True:
      number = input()
